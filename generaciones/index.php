...
<head>
    ...
    <title>Creditx | Generaciones</title>
...
<body ng-controller="Generaciones as C" ng-init="C.Listar(); C.mensaje = 'Listo!';">
    <!-- Modals -->
    <div id="form_nuevo" class="modal" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Agregar generación</h5>
                </div>
                <div class="modal-body">
                    <form ng-submit="C.Crear()">
                        <div class="form-group">
                            <label for="in_generacion">Año de entrada</label>
                            <input ng-model="C.nuevo_generacion" type="text" class="form-control" id="in_generacion"
                                aria-describedby="emailHelp" placeholder="Ejemplo: 2018, 2017">
                        </div>
                        <div class="form-group">
                            <label for="in_grado">Grado actual</label>
                            <input ng-model="C.nuevo_grado" type="text" class="form-control" id="in_grado"
                                aria-describedby="emailHelp" placeholder="Grado actual, 4, 5, etc">
                        </div>
                        <div class="form-group">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form ng-submit="C.Editar()">
                        <div class="form-group">
                            <label for="in_grado">Grado actual</label>
                            <input ng-model="C.editar_grado" type="text" class="form-control" id="in_grado"
                                aria-describedby="emailHelp" placeholder="Grado actual, 4, 5, etc">
                        </div>
                        <div class="form-group">
                            <label>{{ C.mensaje }}</label>
            ...
            <nav class="navbar navbar-default navbar-fixed">
                <div class="container-fluid">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand">Generaciones</a>
                    </div>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card">
                                <div class="header">
                                    <h4 class="title">Lista de Generaciones</h4>
                                ...
                                <div class="content table-responsive table-full-width">
                                    <table class="table table-hover table-striped">
                                        ...
                                        <tbody>
                                            <tr ng-repeat="generacion in generaciones">
                                                <td>{{ generacion['generacion'] }}</td>
                                                <td>{{ generacion['grado'] }}</td>
                                                <td>
                                                    <div class="btn-group" role="group">
                                                        <a ng-click="C.Seleccionar(generacion['generacion'])" type="button"
                                                            class="btn btn-sm btn-warning" data-toggle="modal"
                                                            data-target="#form_editar">Editar</a>
                                                        <a ng-click="C.Eliminar(generacion['generacion'])" type="button"
