...
<body ng-controller="Carreras as C" ng-init="C.Listar(); C.mensaje = 'Listo!';">
    <!-- Modals -->
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form ng-submit="C.Crear()">
                        <div class="form-group">
                            <label for="in_carrera">ID Carrera</label>
                            <input ng-model="C.nuevo_carrera" type="text" class="form-control" id="in_carrera"
                                aria-describedby="emailHelp" placeholder="Ejemplo: TICS, MINAS">
                        </div>
                        <div class="form-group">
            ...
            <nav class="navbar navbar-default navbar-fixed">
                <div class="container-fluid">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand">Carreras</a>
                    </div>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-8">
                            <div class="card">
                                <div class="header">
                                    <h4 class="title">Lista de Carreras</h4>
                                    ...
                                    <table class="table table-hover table-striped">
                                        ...
                                        <tbody>
                                            <tr ng-repeat="carrera in carreras">
                                                ...
                                                <td>
                                                    <div class="btn-group" role="group">
                                                        <a ng-click="C.Seleccionar(carrera['carrera'])" type="button"
                                                            class="btn btn-sm btn-warning" data-toggle="modal"
                                                            data-target="#form_editar">Editar</a>
                                                        <a ng-click="C.Eliminar(carrera['carrera'])" type="button"
