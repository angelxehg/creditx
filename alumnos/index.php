...
<body ng-controller="Alumnos as C" ng-init="C.Listar(); C.mensaje = 'Listo!';">
    <!-- Modals -->
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form ng-submit="C.Crear()">
                        <div class="form-group">
                            <label for="in_matricula">Matricula</label>
                        ...
                        <div class="form-group">
                            ...
                            <input ng-model="C.nuevo_nombre" type="text" class="form-control" id="in_nombre"
                                aria-describedby="emailHelp" placeholder="Escriba el nombre">
                        </div>
                        <div class="form-group">
                            <label for="in_apellidop">Apellido Paterno</label>
                            <input ng-model="C.nuevo_apellidop" type="text" class="form-control" id="in_apellidop"
                                aria-describedby="emailHelp" placeholder="Escriba el Apellido Paterno">
                        </div>
                        <div class="form-group">
                            <label for="in_apellidom">Apellido Materno</label>
                            <input ng-model="C.nuevo_apellidom" type="text" class="form-control" id="in_apellidom"
                                aria-describedby="emailHelp" placeholder="Escriba el Apellido Materno">
                        </div>
                        <div class="form-group">
                            <label for="in_grupo">Grupo</label>
                            <select ng-model="C.nuevo_grupoid" class="form-control" id="in_grupo">
                                <option ng-repeat="elemento in grupos_lista" value="{{ elemento['id'] }}">{{
                                    elemento['titulo']
                                    }}</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="in_genero">Genero</label>
                            <select ng-model="C.nuevo_genero" class="form-control" id="in_genero">
                        ...
                        <div class="form-group">
                            <label for="in_fechan">Fecha Nacimiento</label>
                            <input ng-model="C.nuevo_fechan" type="text" class="form-control" id="in_fechan"
                                aria-describedby="emailHelp" placeholder="Formato AAAA-MM-DD">
                        </div>
                        <div class="form-group">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form ng-submit="C.Editar()">
                        <div class="form-group">
                            <label for="in_matricula">Matricula</label>
                            <input disabled ng-model="C.editar_matricula" type="text" class="form-control" id="in_matricula"
                                aria-describedby="emailHelp" placeholder="Ejemplo: 481800XXX">
                        </div>
                        <div class="form-group">
                            <label for="in_nombre">Nombre</label>
                            <input ng-model="C.editar_nombre" type="text" class="form-control" id="in_nombre"
                                aria-describedby="emailHelp" placeholder="Escriba el nombre">
                        </div>
                        <div class="form-group">
                            <label for="in_apellidop">Apellido Paterno</label>
                            <input ng-model="C.editar_apellidop" type="text" class="form-control" id="in_apellidop"
                                aria-describedby="emailHelp" placeholder="Escriba el Apellido Paterno">
                        </div>
                        <div class="form-group">
                            <label for="in_apellidom">Apellido Materno</label>
                            <input ng-model="C.editar_apellidom" type="text" class="form-control" id="in_apellidom"
                                aria-describedby="emailHelp" placeholder="Escriba el Apellido Materno">
                        </div>
                        <div class="form-group">
                            <label for="in_grupo">Grupo</label>
                            <select ng-model="C.editar_grupoid" class="form-control" id="in_grupo">
                                <option ng-repeat="elemento in grupos_lista" value="{{ elemento['id'] }}">{{
                                    elemento['titulo']
                                    }}</option>
                            </select>
                        ...
                        <div class="form-group">
                            <label for="in_genero">Genero</label>
                            <select ng-model="C.editar_genero" class="form-control" id="in_genero">
                                <option value="M">Masculino</option>
                                <option value="F">Femenino</option>
                                <option value="O">Otro</option>
                            </select>
                        ...
                        <div class="form-group">
                            <label for="in_fechan">Fecha Nacimiento</label>
                            <input ng-model="C.editar_fechan" type="text" class="form-control" id="in_fechan"
                                aria-describedby="emailHelp" placeholder="Formato AAAA-MM-DD">
                        </div>
                        <div class="form-group">
                            <label>{{ C.mensaje }}</label>
    ...
    <div id="form_creditos" class="modal" tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Agregar creditos</h5>
                    </div>
                    <div class="modal-body">
                        <form ng-submit="C.AgregarCreditos()">
                            <div class="form-group">
                                <label for="in_actividad">Actividad</label>
                                <select ng-model="C.nuevo_actividadid" class="form-control" id="in_actividad">
                                    <option ng-repeat="elemento in actividades_lista" value="{{ elemento['id'] }}" ng-click="C.nuevo_cantidad = elemento['datos']['cantidad']">{{
                                        elemento['titulo']
                                        }}</option>
                                </select>
                            </div>
                                    ...
                                    <table class="table table-hover table-striped">
                                        ...
                                        <tbody>
                                            <tr ng-repeat="alumno in alumnos">
                                                ...
                                                <td>{{ alumno['nombrecom'] }}</td>
                                                <td>{{ alumno['gruponom'] }}</td>
                                                <td>{{ alumno['genero'] }}</td>
                                                <td>{{ alumno['creditos'] }}</td>
                                                <td>{{ alumno['fechan'] }}</td>
                                                <td>
                                                    <div class="btn-group" role="group">
                                                        <a ng-click="C.Seleccionar(alumno['matricula'])" type="button"
                                                            class="btn btn-sm btn-success" data-toggle="modal"
                                                            data-target="#form_creditos">Añadir Creditos</a>
                                                        <a ng-click="C.Seleccionar(alumno['matricula'])" type="button"
                                                            class="btn btn-sm btn-warning" data-toggle="modal"
                                                            data-target="#form_editar">Editar</a>
                                                        <a ng-click="C.Eliminar(alumno['matricula'])" type="button"
