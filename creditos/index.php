...
<body ng-controller="Creditos as C" ng-init="C.Listar(); C.mensaje = 'Listo!';">
    <!-- Modals -->
    ...
    <div id="form_editar" class="modal" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Editar creditos</h5>
                </div>
                <div class="modal-body">
                    <form ng-submit="C.Editar()">
                        <div class="form-group">
                            <label for="in_actividad">Actividad</label>
                            <select ng-model="C.editar_actividadid" class="form-control" id="in_actividad">
                                <option ng-repeat="elemento in actividades_lista" value="{{ elemento['id'] }}" ng-click="C.editar_cantidad = elemento['datos']['cantidad']">{{
                                    elemento['titulo']
                                    }}</option>
                            </select>
                        </div>
            ...
            <nav class="navbar navbar-default navbar-fixed">
                <div class="container-fluid">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand">Creditos</a>
                    </div>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-8">
                            <div class="card">
                                <div class="header">
                                    <h4 class="title">Lista de Creditos</h4>
                                    ...
                                    <div class="btn-group" role="group">
                                        ...
                                        <a type="button" ng-click="C.Filtrar()" class="btn btn-sm btn-secondary">Filtrar</a>
                                    </div>
                                    <input ng-model="C.filtrar_matricula" type="text" class="form-control form-control-sm" placeholder="Filtrar por matricula. Ejemplo: 481800XXX">
                                </div>
                                    ...
                                    <table class="table table-hover table-striped">
                                        ...
                                        <tbody>
                                            <tr ng-repeat="credito in creditos">
                                                <td>{{ credito['creditoid'] }}</td>
                                                <td>{{ credito['titulo'] }}</td>
                                                <td>{{ credito['matricula'] }}</td>
                                                <td>{{ credito['nombrecom'] }}</td>
                                                <td>{{ credito['gruponom'] }}</td>
                                                <td>{{ credito['cantidad'] }}</td>
                                                <td>{{ credito['fechac'] }}</td>
                                                <td>
                                                    <div class="btn-group" role="group">
                                                        <a ng-click="C.Seleccionar(credito['creditoid'])" type="button"
                                                            class="btn btn-sm btn-warning" data-toggle="modal"
                                                            data-target="#form_editar">Editar</a>
                                                        <a ng-click="C.Eliminar(credito['creditoid'])" type="button"
